  ...
  return (
    <div className="relative">
      <img
        ...
        className="absolute z-[-1] top-1/2 left-[350px] md:opacity-70 h-96 xs:hidden lg:inline"
      />
      <img
        src="backgroundfloral.png"
        style={{ clipPath: 'inset(0 0 0 50%)' }}
        className="absolute z-[-1] top-1/2 right-[350px] md:opacity-70 h-96 xs:hidden lg:inline"
      />
      <Carousel />
